...
export default function Home() {
    return (
        <div className="m-4 space-y-4">
            ...
            <div className="space-y-4">
                <h2 className="text-black text-2xl leading-tight">Tata Cara Salat Wajib</h2>

                <div className="space-y-2">
                    <h2 className="text-black text-xl leading-tight">Membaca Niat Salat</h2>

                    <p>
                        Baca lah niat sebelum atau ketika takbiratul ihram yang pertama, dalam hati, tenang, dan
                        pandangan
